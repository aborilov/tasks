...
func (_m *MockRepository) Add(_a0 context.Context, _a1 *User) (*User, error) {
...
func (_m *MockRepository) Get(ctx context.Context, id int64) (*User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockRepository) List(_a0 context.Context) ([]*User, error) {
	ret := _m.Called(_a0)
...
func (_m *MockRepository) Update(_a0 context.Context, _a1 *User) (*User, error) {
	ret := _m.Called(_a0, _a1)
